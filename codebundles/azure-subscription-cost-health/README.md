...
- **Large Dataset Support**: Uses temporary files (created in current directory) instead of command-line arguments to avoid "Argument list too long" errors with 500+ cost records. Temporary files are automatically cleaned up after processing.
