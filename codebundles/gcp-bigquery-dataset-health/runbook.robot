...
Suite Initialization
    ...
    Set Suite Variable
    ...    ${env}
    ...    {"CLOUDSDK_BILLING_QUOTA_PROJECT":"${GCP_PROJECT_ID}","CLOUDSDK_CORE_PROJECT":"${GCP_PROJECT_ID}","PATH":"$PATH:${OS_PATH}","GCP_PROJECT_ID":"${GCP_PROJECT_ID}","TABLE_SIZE_THRESHOLD_GB":"${TABLE_SIZE_THRESHOLD_GB}","TABLE_GROWTH_THRESHOLD_PERCENT":"${TABLE_GROWTH_THRESHOLD_PERCENT}","INCLUDE_STREAMING_BUFFER":"${INCLUDE_STREAMING_BUFFER}"}
    RW.CLI.Run CLI
