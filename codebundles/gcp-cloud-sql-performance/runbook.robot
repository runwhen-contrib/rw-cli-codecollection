...
Suite Initialization
    ...
    Set Suite Variable
    ...    ${env}
    ...    {"CLOUDSDK_BILLING_QUOTA_PROJECT":"${GCP_PROJECT_ID}","CLOUDSDK_CORE_PROJECT":"${GCP_PROJECT_ID}","PATH":"$PATH:${OS_PATH}","GCP_PROJECT_ID":"${GCP_PROJECT_ID}","RESOURCES":"${RESOURCES}","CPU_THRESHOLD_PERCENT":"${CPU_THRESHOLD_PERCENT}","UTILIZATION_HOURS":"${UTILIZATION_HOURS}","LONG_QUERY_SECONDS":"${LONG_QUERY_SECONDS}","STORAGE_FILL_THRESHOLD_PERCENT":"${STORAGE_FILL_THRESHOLD_PERCENT}"}
    RW.CLI.Run CLI
