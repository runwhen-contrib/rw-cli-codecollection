...
Suite Initialization
    ...
    Set Suite Variable
    ...    ${env}
    ...    {"PATH":"$PATH:${OS_PATH}","GCP_PROJECT_ID":"${GCP_PROJECT_ID}","CPU_UTILIZATION_THRESHOLD":"${CPU_UTILIZATION_THRESHOLD}","MULTI_REGION_CPU_UTILIZATION_THRESHOLD":"${MULTI_REGION_CPU_UTILIZATION_THRESHOLD}","STORAGE_UTILIZATION_THRESHOLD":"${STORAGE_UTILIZATION_THRESHOLD}","STORAGE_LIMIT_GB_PER_NODE":"${STORAGE_LIMIT_GB_PER_NODE}","LATENCY_THRESHOLD_MS":"${LATENCY_THRESHOLD_MS}","ERROR_RATE_THRESHOLD_PERCENT":"${ERROR_RATE_THRESHOLD_PERCENT}","LONG_RUNNING_OPERATION_MINUTES":"${LONG_RUNNING_OPERATION_MINUTES}"}
    RW.CLI.Run CLI
