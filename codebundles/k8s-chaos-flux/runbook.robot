...
*** Tasks ***
Suspend Flux Deployment Resource Reconciliation in Namespace `$${FLUX_RESOURCE_NAMESPACE}`
...
Inspect and Select Random Deployment in FluxCD Workload for Chaos Testing
...
Execute Chaos Command on Kubernetes OOM Resource
...
Run Additional Command in Kubernetes Cluster
...
Resume Reconciliation of Flux Resource in Kubernetes
