...
Suite Initialization
    ...
    TRY
        ...
        ...    type=string
        ...    description=LiteLLM master or admin API key for protected routes.
        ...    pattern=\w*
        Set Suite Variable    ${litellm_master_key}    ${litellm_master_key}
    EXCEPT
        Log    litellm_master_key secret not found; protected routes may return 401 until configured.    WARN
    ...
    ...    type=string
    ...    description=Base URL for the LiteLLM HTTP API (for example http://127.0.0.1:4000 when using kubectl port-forward).
    ...    pattern=.*
