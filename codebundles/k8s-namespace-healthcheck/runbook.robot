...
Inspect Container Restarts In Namespace `${NAMESPACE}`
    ...
    ...    cmd=cat ${RUNWHEN_TEMP_DIR}/container_restart_issues.json
    ...    env=${env}
    ...    include_in_history=false
