...
Suite Initialization
    ...
    ...    type=string
    ...    description=The time window (in (h) hours or (m) minutes) to look back for failed pods. Pods that failed before this window will be ignored.
    ...    pattern=\w*
    ...    example=1h
    ...    default=1h
