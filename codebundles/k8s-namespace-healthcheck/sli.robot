...
*** Tasks ***
Capture and Count Error Events in NAMESPACE within the Last EVENT_AGE with a Threshold of EVENT_THRESHOLD
...
Count Container Restarts in NAMESPACE within EVENT_AGE and Determine Threshold Exceedance
...
Calculate Namespace Performance Score
