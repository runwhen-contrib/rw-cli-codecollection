...
*** Tasks ***
Validate Selector Mappings for Prometheus Service Monitors in Namespace
...
Check Operator Instance Logs for Successful Rule Setup in Kubernetes Cluster
...
Verify Prometheus RBAC Permissions for Accessing ServiceMonitors in Kubernetes Cluster
...
Inspect Prometheus Operator Logs for Endpoint Scraping Errors
...
Check Prometheus API Healthy in Kubernetes Cluster
